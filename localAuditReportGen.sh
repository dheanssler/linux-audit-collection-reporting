...
###ENDOFFUNCTIONS###
if [ ! -d /var/log/otherInfo ]; then
	mkdir -p /var/log/otherInfo
fi
mv -f /tmp/otherInfo/* /var/log/otherInfo

#Filter out specific lines from Audit Reports
date +%Y%m%d >> /var/log/otherInfo/removedFromReports
for i in $(ls -d /var/log/otherInfo/auditReport_*); do
	grep -E "auditctl\s+\(none\)\s+\?\s+unset\s+[0-9]{1,3}$" $i >> /var/log/otherInfo/removedFromReports
	sed -i -E '/auditctl\s+\(none\)\s+\?\s+unset\s+[0-9]{1,3}$/d' $i
	grep -E "sendto\s+yes\s+\/usr\/sbin\/auditctl\s+unset\s+[0-9]{1,3}$" $i >> /var/log/otherInfo/removedFromReports
	sed -i -E '/sendto\s+yes\s+\/usr\/sbin\/auditctl\s+unset\s+[0-9]{1,3}$/d' $i
	grep -E "unset\s+\(none\)\s+\?\s+\/usr\/sbin\/auditctl\s+[0-9]{1,3}$" $i >> /var/log/otherInfo/removedFromReports
	sed -i -E '/unset\s+\(none\)\s+\?\s+\/usr\/sbin\/auditctl\s+[0-9]{1,3}$/d' $i
done

#Generate Logwatch Reports
printf "Generating logwatch report for $(hostname)...\n"
hostname=$(hostname | awk -F "." '{print $1}') #included to extract the hostname from a FQDN
logwatch --detail high --numeric --range all --hostlimit $hostname --logdir /var/log/ > /var/log/otherInfo/$hostname"_logwatch"`date +%Y%m%d`


#Compile reports
printf "Generating final report for $(hostname)...\n"
...
cat /var/log/otherInfo/$hostname"_logwatch"`date +%Y%m%d` >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_identity >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_privileged-priv_change >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
printf "\n=FULL CONTEXT BELOW=\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditFull_privileged-priv_change >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_privileged-chage >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
printf "\n=FULL CONTEXT BELOW=\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditFull_privileged-chage >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_perm_mod >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_privileged-passwd >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
printf "\n=FULL CONTEXT BELOW=\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditFull_privileged-passwd >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_privileged-mount >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-unix-update >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-pam_timestamp_check >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_priv_cmd >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
printf "\n=FULL CONTEXT BELOW=\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditFull_priv_cmd >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-gpasswd >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_module_chng >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
printf "\n=FULL CONTEXT BELOW=\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditFull_module_chng >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-crontab >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator or cybersecurity team member.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-usermod >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_logins >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_execpriv >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator or cybersecurity team member.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_privileged-ssh >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_delete >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator or cybersecurity team member.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_perm_access >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
cat /var/log/otherInfo/auditReport_modules >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_audit-tools >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
...
printf "What should I look for?\nEvents where the auid does not belong to a system administrator or cybersecurity team member.\n\n" >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
cat /var/log/otherInfo/auditReport_security-relevant-object >> /var/log/completedReports/$hostname/$hostname"_Report_"`date +%Y%m%d`
###
